...
DROP POLICY IF EXISTS "Public insert to students" ON students;
CREATE POLICY "Public insert to students" ON students FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Public update to students" ON students;
CREATE POLICY "Public update to students" ON students FOR UPDATE USING (true);
DROP POLICY IF EXISTS "Public delete to students" ON students;
...
DROP POLICY IF EXISTS "Public insert to absences" ON absences;
CREATE POLICY "Public insert to absences" ON absences FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Public update to absences" ON absences;
CREATE POLICY "Public update to absences" ON absences FOR UPDATE USING (true);
DROP POLICY IF EXISTS "Public delete to absences" ON absences;
...
DROP POLICY IF EXISTS "Public insert to reports" ON reports;
CREATE POLICY "Public insert to reports" ON reports FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Public update to reports" ON reports;
CREATE POLICY "Public update to reports" ON reports FOR UPDATE USING (true);
DROP POLICY IF EXISTS "Public delete to reports" ON reports;
